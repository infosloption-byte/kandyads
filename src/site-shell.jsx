...
export function FloatingActions(){return <div className="float-actions"><a href="https://wa.me/94770000000" aria-label="WhatsApp"><MessageCircle/></a><Link to="/quote" aria-label="Request a quote"><ArrowUpRight/></Link></div>}
...
export function Footer(){
  return <footer><div className="container footer-grid">
    <div><Link to="/" className="brand footer-brand"><img src={LOGO} alt="Kandy Ads"/><span>KANDY<span>ADS</span></span></Link><p>Creative advertising, signage and brand visibility solutions from Kandy, Sri Lanka.</p><div className="footer-contact"><a href="tel:+94770000000"><Phone size={14}/> +94 77 000 0000</a><a href="mailto:info@kandyads.lk"><Mail size={14}/> info@kandyads.lk</a><span><MapPin size={14}/> Kandy, Sri Lanka</span></div></div>
    ...
    <div><b>Start a project</b><p className="footer-note">Tell us what you need and we’ll shape the right production path.</p><Link to="/quote" className="footer-cta">Get a Quote <ArrowUpRight size={16}/></Link><a href="https://wa.me/94770000000" className="footer-cta">WhatsApp <ArrowUpRight size={16}/></a></div>
