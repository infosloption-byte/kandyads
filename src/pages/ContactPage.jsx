    ...
    <section className="container contact-grid">
      <div>
        <div className="contact-card">
          ...
          <h3>{contactInfo.phones[0]}</h3>
          <p>For quick project discussions, measurements, site requirements and questions.</p>
          <a href={`https://wa.me/${contactInfo.whatsapp}`}><MessageCircle size={16}/> Start a WhatsApp conversation <ArrowUpRight size={16}/></a>
        </div>
        <div className="contact-card">
          <Phone/>
          <span>OFFICE PHONE</span>
          <h3>{contactInfo.phones[1]}</h3>
          <p>Call the office for project coordination and general enquiries.</p>
          <a href={contactInfo.phoneHrefs[1]}><Phone size={16}/> Call the office <ArrowUpRight size={16}/></a>
        </div>
        <div className="contact-card">
          <Mail/>
          <span>EMAIL ADDRESS</span>
          <h3>{contactInfo.emails[0]}</h3>
        ...
        <div className="contact-card">
          <MapPin/>
          <span>LOCATION</span>
          <h3>{contactInfo.addresses[0]}</h3>
          <p>Our main location for project discussions and coordination.</p>
        </div>
      </div>
      <form className="quote-form" onSubmit={e=>e.preventDefault()}>
        ...
        <label>Email<input type="email" placeholder="info@kandyads.lk"/></label>
