...
import { Bell, BarChart3, BriefcaseBusiness, ClipboardList, DollarSign, FileText, FolderKanban, HardHat, LayoutDashboard, LogOut, Menu, Package, Settings, ShoppingCart, Truck, Users, Wrench, Building2, X } from 'lucide-react';
...
function Shell({ user, onLogout }) {
  const [open, setOpen] = React.useState(false); const [toast, setToast] = React.useState(null);
