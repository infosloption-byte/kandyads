...
export const api={
 ...
 listEmployees:p=>list('employees',p),getEmployee:id=>request(`/employees/${id}`),getEmployeeWorkload:p=>list('employees/workload',p),createEmployee:i=>create('employees',i),updateEmployee:(id,i)=>patch('employees',id,i),
