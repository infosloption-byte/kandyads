...
import JobAttachmentsPage from '../features/jobs/pages/JobAttachmentsPage';
...
import HoursReportPage from '../features/reports/pages/HoursReportPage';
...
import SettingsMasterDataPage from '../features/settings/pages/SettingsMasterDataPage';
import SettingsCataloguesPage from '../features/settings/pages/SettingsCataloguesPage';
import WorkflowConfigurationPage from '../features/settings/pages/WorkflowConfigurationPage';
...
export default function AdminRouter({ user }) {
  ...
  return <Routes>
   <Route path="/" element={<DashboardPage/>}/><Route path="/leads" element={<LeadsPage/>}/><Route path="/leads/:id" element={<LeadDetailPage/>}/><Route path="/clients" element={<ClientsPage/>}/><Route path="/clients/:id" element={<ClientDetailPage/>}/><Route path="/enquiries" element={<EnquiriesPage/>}/><Route path="/enquiries/:id" element={<EnquiryDetailPage/>}/><Route path="/quotes" element={<QuotesPage/>}/><Route path="/quotes/:id" element={<QuoteDetailPage/>}/><Route path="/projects" element={<ProjectsPage/>}/><Route path="/projects/:id" element={<ProjectDetailPage/>}/><Route path="/jobs" element={<JobsPage/>}/><Route path="/jobs/:id" element={<JobDetailPage/>}/><Route path="/jobs/:id/attachments" element={<JobAttachmentsPage/>}/><Route path="/tasks" element={<TasksPage/>}/><Route path="/tasks/:id" element={<TaskDetailPage/>}/><Route path="/employees" element={<EmployeesPage/>}/><Route path="/employees/workload" element={<EmployeeWorkloadPage/>}/><Route path="/employees/capabilities" element={<EmployeeCapabilitiesPage/>}/><Route path="/reports" element={<HoursReportPage/>}/><Route path="/time" element={<TimeTrackingPage/>}/><Route path="/materials" element={<MaterialsPage/>}/><Route path="/inventory" element={<InventoryPage/>}/><Route path="/vendors" element={<VendorsPage/>}/><Route path="/vendors/:id" element={<VendorDetailPage/>}/><Route path="/outsourcing" element={<OutsourcingPage/>}/><Route path="/expenses" element={<ExpensesPage/>}/><Route path="/purchasing" element={<PurchasingPage/>}/><Route path="/profitability" element={<ProfitabilityPage/>}/><Route path="/installations" element={<InstallationsPage/>}/><Route path="/invoices" element={<InvoicesPage/>}/><Route path="/approvals" element={<ApprovalsPage/>}/><Route path="/settings" element={<SettingsPage/>}/><Route path="/settings/master-data" element={<SettingsMasterDataPage/>}/><Route path="/settings/catalogues" element={<SettingsCataloguesPage/>}/><Route path="/settings/workflows" element={<WorkflowConfigurationPage/>}/>
  </Routes>;
}
