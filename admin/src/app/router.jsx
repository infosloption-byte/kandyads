...
const modulePages = [
  ['leads','Leads'],['materials','Materials'],['inventory','Inventory'],['purchasing','Purchasing'],['outsourcing','Outsourcing'],['installations','Installations'],['expenses','Expenses'],['invoices','Invoices'],['profitability','Profitability'],['reports','Reports'],['settings','Settings'],
];
