...
const placeholderPages = [
  ['leads','Leads'],['installations','Installations'],['invoices','Invoices'],['profitability','Profitability'],['reports','Reports'],['settings','Settings'],
];
