...
const blank={jobId:'',title:'',description:'',notes:'',employeeId:'',priority:'',startDate:'',dueDate:'',estimatedHours:'',status:'PENDING'};
...
export default function TaskForm({jobs=[],employees=[],initialValues,onSubmit,onCancel,submitting=false,editMode=false}){
 ...
 return <form className="entity-form" onSubmit={submit}><div className="form-grid two">
  ...
  <label className="full">Production notes<textarea rows="4" value={form.notes} onChange={set('notes')} placeholder="Internal production notes, handover details, or special instructions" /></label>
